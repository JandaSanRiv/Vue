...
<script>
export default {
  // data, methods, computed, watch, LCM (LifeCycle Methods)
  data() {
    return {
      // Shared
      // Shared
  ...
  watch: {
    input3: {
      ...
      immediate: true, // El watcher esta disponible durante los Lifecycle Hook beforecreate, created,beforeMount, mounted
    },
  },
  computed: {
    computedList() {
      console.log('computedList is being calculated... ')
